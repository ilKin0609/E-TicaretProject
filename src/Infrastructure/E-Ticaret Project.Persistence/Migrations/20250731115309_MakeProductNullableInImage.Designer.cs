...
namespace E_Ticaret_Project.Persistence.Migrations
{
    ...
    [Migration("20250731115309_MakeProductNullableInImage")]
    partial class MakeProductNullableInImage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AboutUs", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 31, 11, 53, 9, 296, DateTimeKind.Utc).AddTicks(5552),
            ...
            modelBuilder.Entity("E_Ticaret_Project.Domain.Entities.ContactInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 7, 31, 11, 53, 9, 297, DateTimeKind.Utc).AddTicks(3764),
                            Email = "info@labstend.com",
                            FacebookUrl = "https://facebook.com/labstend",
                            InstagramUrl = "https://instagram.com/labstend",
                            IsActive = true,
                            IsDeleted = false,
                            MapIframeSrc = "https://maps.google.com/?q=labstend",
                            Phone = "+994 50 123 45 67",
                            YoutubeUrl = "https://youtube.com/labstend"
                        });
                });
            ...
            modelBuilder.Entity("E_Ticaret_Project.Domain.Entities.Image", b =>
                {
                    ...
                    b.HasIndex("AboutUsId")
                        .IsUnique()
                        .HasFilter("[AboutUsId] IS NOT NULL");
            ...
            modelBuilder.Entity("E_Ticaret_Project.Domain.Entities.SpecialRequestImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SpecialRequestImages");
                });
            ...
            modelBuilder.Entity("SiteSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
                            CreatedAt = new DateTime(2025, 7, 31, 11, 53, 9, 298, DateTimeKind.Utc).AddTicks(1352),
            ...
            modelBuilder.Entity("E_Ticaret_Project.Domain.Entities.Image", b =>
                {
                    ...
                    b.HasOne("E_Ticaret_Project.Domain.Entities.ContactInfo", "ContactInfo")
                        .WithOne("Image")
                        .HasForeignKey("E_Ticaret_Project.Domain.Entities.Image", "ContactInfoId")
                        .OnDelete(DeleteBehavior.Cascade);

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleAZ = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    TitleEN = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    TitleRU = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Duty = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressAZ = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    AddressEN = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    AddressRU = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    MapIframeSrc = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Email = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    OrderAbout = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedUser = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedUser = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MetaTitleAz = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    MetaTitleRu = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    MetaTitleEng = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    MetaDescriptionAz = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    MetaDescriptionRu = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    MetaDescriptionEng = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Keywords = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    NameAZ = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),

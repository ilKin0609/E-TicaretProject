...
namespace E_Ticaret_Project.Persistence.Migrations
{
    ...
    [Migration("20250809085628_CategoryConfigurated")]
    partial class CategoryConfigurated
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AboutUs", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 8, 9, 8, 56, 28, 456, DateTimeKind.Utc).AddTicks(8592),
            ...
            modelBuilder.Entity("E_Ticaret_Project.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasIndex("VisitCount");

                    b.HasIndex("IsVisible", "Order");

                    b.HasIndex("IsPopular", "IsVisible", "Order");
            ...
            modelBuilder.Entity("E_Ticaret_Project.Domain.Entities.ContactInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 8, 9, 8, 56, 28, 457, DateTimeKind.Utc).AddTicks(8595),
            ...
            modelBuilder.Entity("SiteSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
                            CreatedAt = new DateTime(2025, 8, 9, 8, 56, 28, 458, DateTimeKind.Utc).AddTicks(5841),
